...
// Fetch students data from the database for the active session only, including class name
$query = "
    ...
    INNER JOIN tblsessionterm st ON st.id = w.sessionId AND st.isActive = '1'"; // Limit to active session
