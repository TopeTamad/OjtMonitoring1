            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">TOPE Entry</h1>
                        <?php echo $statusMsg; ?>
                        <ol class="breadcrumb">
                                            ...
                                            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($archiveExists && mysqli_num_rows($archiveExists) > 0) {
                                                        ...
                                                        WHERE a.Id IS NULL
                                                          AND NOT EXISTS (
                                                            SELECT 1 FROM tbl_weekly_time_entries w
                                                            INNER JOIN tblsessionterm st ON st.Id = w.sessionId
                                                            WHERE w.admissionNumber = s.admissionNumber
                                                              AND (st.isActive = '0' OR st.sessionName = '2024/2025')
                                                          )";
                                                    } else {
