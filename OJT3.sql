...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2026 at 04:01 AM
...
(14, 5, 'Fernand Layug', 'PASS ALL THE PAPERS', '', '2026-01-19 07:44:05', 0),
(15, 5, 'Fernand Layug', 'HAHAA', '', '2026-01-20 07:50:45', 0),
(16, 5, 'Fernand Layug', 'AHAHHA', '', '2026-01-21 02:17:54', 0),
(17, 5, 'Fernand Layug', 'sadasdasdda', '', '2026-01-21 07:11:58', 1);
...
INSERT INTO `tblaudit_log` (`id`, `admin_id`, `admin_email`, `action`, `students`, `affected_record`, `details`, `ip_address`, `user_agent`, `created_at`) VALUES
(1, 5, 'f.layug@src.edu.ph', 'update_student', 'Roy POGI Juntilla', 'tblstudents#89', 'admissionNumber=22-0002155, email=juntillaroy@src.edu.ph', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0', '2026-01-21 06:10:56'),
(2, 5, 'f.layug@src.edu.ph', 'update_company', NULL, 'tblcompany#1', 'comp_name=Santa Rita College of Pampanga', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0', '2026-01-21 06:11:43'),
(3, 5, 'f.layug@src.edu.ph', 'create_announcement', NULL, 'tblannouncement#0', 'content_length=11', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0', '2026-01-21 06:11:58');
...
(1, 'Santa Rita College of Pampanga', 'Fernand Layug', '09255697045', 'Carlos Mariano St. , San Jose, Santa Rita, Pampanga', '09255697045211'),
...
(87, '22-0002148', 'Mark Glen Guevarra', 'BSIS 4A', 'hello po', '2026-01-16 06:27:40', 'bading', 'src admin', '2026-01-19 05:42:42', 'replied', 2),
(88, '22-0002152', 'Micaella Millos', 'BSIS 4A', 'AWIT', '2026-01-19 05:54:00', NULL, NULL, NULL, 'pending', 2),
(89, '22-0002148', 'Mark Glen Guevarra', 'BSIS 4A', 'IM GODS', '2026-01-19 06:23:04', NULL, NULL, NULL, 'pending', 2),
(90, '22-0002148', 'Mark Glen Guevarra', 'BSIS 4A', 'ABDUL', '2026-01-19 06:23:53', NULL, NULL, NULL, 'pending', 2);
...
(89, '22-0002155', 'Roy POGI', 'Juntilla', '1', NULL, '09264882133', 'Santa Rita College of Pampanga', 'juntillaroy@src.edu.ph', 'Zone 2 Dila-Dila, Sta.Rita Pampanga', 'Juntillaroy20*', '2026-01-15', 500, 500, '', 0),
(90, '22-0002148', 'Mark Glen abdulsads', 'Guevarra', '1', NULL, '09187334929', 'Santa Rita College of Pampanga', 'markguevarra@src.edu.ph', 'Zone 1 San-Basilio Sta.Rita Pampanga', 'pekpek123', '2026-01-15', 200, 500, '', 1),
(91, '22-0002152', 'Micaella', 'Millos', '1', NULL, '09503126278', 'Santa Rita College of Pampanga', 'micaellamillos@src.edu.ph', 'Purok 1 Sepung Bulaon Porac Pampanga', 'Micaypineda31', '2026-01-15', 300, 500, '', 0),
(92, '22-0002141', 'Princess', 'Calma', '1', NULL, '09762111276', 'Santa Rita College of Pampanga', 'princesscalma@src.edu.ph', 'Zone 3 San Isidro Santa Pampanga', 'taneydamobugok', '2026-01-15', 450, 500, '', 0);
...
--
-- Dumping data for table `tblstudents_archive`
--

INSERT INTO `tblstudents_archive` (`Id`, `admissionNumber`, `firstName`, `lastName`, `classId`, `contact`, `comp_name`, `email`, `address`, `password`, `dateCreated`, `render_time`, `remaining_time`, `comp_link`, `archive_sessionId`, `archived_at`) VALUES
(52, '210001212', 'Ian Carlo', 'Garcia', '1', '09612961794', 'Santa Rita College of Pampanga (MIS Office)', 'ian.garcia@src.edu.ph', 'San Agustin, Sta. Rita, Pampanga', 'henmarian02', '2025-03-05', 500, 150, '', 1, '2026-01-19 13:44:59'),
(26, '210000903', 'Mykel Roi', 'Mangiliman', '2', '09317886538', 'Porac (Commision on Election)', 'm.mangiliman@src.edu.ph', 'Purok 1 Pulung Santol Porac Pampanga', 'pororoi14', '2025-03-04', 500, 500, '', 1, '2026-01-20 11:43:06');
...
(96, 'markguevarra@src.edu.ph', 'pekpek123', 'Student'),
...
CREATE TABLE `tbl_sessions` (
  ...
  `dtr_submission_start` datetime NOT NULL,
  `dtr_submission_end` datetime NOT NULL,
